...
export const ENEMY_CODEX={
 ...
 spear:{role:"JÄGER",visualClass:"normal",visualScale:1,name:"Speerjäger",icon:"🔱",baseHp:72,hpWave:11,baseSpeed:39,speedWave:.45,reward:17,damage:36,attackRate:1.12,armor:0,color:"#536345",unlockWave:3,lore:"Erfahrener Jäger mit langem Speer. Er kann aus der zweiten Reihe über vordere Angreifer hinweg Burgwachen und Andreas treffen; Bogenschützen erleiden nur bei echtem Nahkontakt Schaden.",strength:"Angriff aus zweiter Reihe",weakness:"Bogenschützen · Flächenschaden",ability:"Speerreichweite: greift Burgwachen und Andreas aus der zweiten Reihe bis etwa 70 Entfernung an.",counter:"Mit Bogenschützen fokussieren oder durch Katapulttreffer aus der Formation lösen."},
