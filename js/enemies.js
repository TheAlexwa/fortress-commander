...
export function enemyStatsFor(type,wave=1){
 ...
 return {name:d.name,icon:d.icon,hp:d.baseHp+wave*d.hpWave,speed:d.baseSpeed+wave*d.speedWave,radius,reward:d.reward,damage:d.damage,attackRate:d.attackRate,armor:d.armor||0,color:d.color,lore:d.lore,strength:d.strength,weakness:d.weakness,role:d.role||"KRIEGER",boss:!!d.boss};
}
