...
const GAME_RELEASE_NAME="Upgrade-Zentrale optisch poliert";
...
function upgradeEntityCost(entity){
 ...
 // Einheiten werden ausschließlich über EXP-Aufwertungen oder Forschung verbessert.
 if(entity.kind==="unit")return {gold:0,wood:0,maxed:true};
...
function upgradeRecommendation(){
 ...
 return "Sammle Gold und Holz in der nächsten Welle. Einheiten werden über EXP oder Forschung verbessert; priorisiere Gebäude nach Engpass.";
}
