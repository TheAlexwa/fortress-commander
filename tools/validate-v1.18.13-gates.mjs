...
if(failures.length){
  console.error("v1.18.18-Torpruefung fehlgeschlagen:\n- "+failures.join("\n- "));
  process.exit(1);
}
console.log("v1.18.18-Torpruefung erfolgreich: eigene Torpassage, mehrstufige Wegpunkte, dynamische Angriffsziele, Überlastungsmalus und Breschenwahl bestaetigt.");
