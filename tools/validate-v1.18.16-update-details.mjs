...
if(notes.version!=="1.18.16")failures.push("release-notes.json hat falsche Version");
if(notes.title!=="Update-Details & Anleitung")failures.push("release-notes.json hat falschen Titel");
...
for(const marker of [
 ...
 "Burg, Mauern, Tore, Türme und Versorgungsgebäude"
...
])requireText(main,marker,"v1.18.16 Versionsangabe fehlt");
...
if(failures.length){
 console.error("v1.18.16-Update-und-Anleitungspruefung fehlgeschlagen:\n- "+failures.join("\n- "));
 process.exit(1);
}
console.log("v1.18.16-Update-und-Anleitungspruefung erfolgreich: Patchdetails, netzwerkfrische Release-Notes, mobile Darstellung, aktualisierte Anleitung und unveraenderte Kampfwerte bestaetigt.");
