...
for(const text of ['CACHE_NAME="fortress-commander-v1.18.0"','type==="SKIP_WAITING"','request.mode==="navigate"'])
...
for(const required of ["./index.html","./manifest.webmanifest","./js/main.js","./js/pwa.js","./assets/icons/icon-512.png"]){
