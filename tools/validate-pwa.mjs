...
for(const text of ['CACHE_NAME="fortress-commander-v1.18.17-r2"','type==="SKIP_WAITING"','request.mode==="navigate"'])
...
for(const required of ["./index.html","./manifest.webmanifest","./js/main.js","./js/pwa.js","./js/audio.js","./js/troops.js","./assets/icons/icon-512.png","./assets/ui/campaign-map-v1.18.7.webp","./assets/audio/wave-horn.mp3","./assets/audio/music-menu.mp3","./assets/audio/ambience-wind.mp3"]){
