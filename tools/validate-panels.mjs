...
for(const file of ["index.html","README.md","CHANGELOG.md","js/main.js"]){
 ...
 requireText(content,"1.18.3",`Versionsangabe fehlt in ${file}`);
}
const forbidden=[
...
console.log(`Fensterprüfung erfolgreich: ${expected.length} Dialoge, zentrale Steuerung und Version 1.18.3 bestätigt.`);
