...
for(const file of ["index.html","README.md","CHANGELOG.md","js/main.js"]){
 ...
 requireText(content,"1.18.7",`Versionsangabe fehlt in ${file}`);
}
const forbidden=[
...
console.log(`Fensterprüfung erfolgreich: ${expected.length} Dialoge, zentrale Steuerung, Einheitenbuch, Truppenanzeige und Version 1.18.7 bestätigt.`);
