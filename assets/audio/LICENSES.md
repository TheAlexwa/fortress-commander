# Audioquellen – Fortress Commander v1.18.7
...
Quelle und Lizenz: https://mixkit.co/free-sound-effects/

| Datei im Spiel | Originaltitel / Originaldatei | Verwendet für |
|---|---|---|
| `ui-click.mp3` | Select click (`mixkit-select-click-1109.wav`) | Allgemeine Bedienung |
| `ui-close.mp3` | Page back chime / Software interface back (`mixkit-page-back-chime-1108.wav`) | Fenster schließen |
| `ui-error.mp3` | Click error (`mixkit-click-error-1110.wav`) | Ungültige Aktion |
| `build-place.mp3` | Metal medieval construction (`mixkit-construction sounds-833.wav`) | Gebäude errichten |
| `upgrade-complete.mp3` | Fantasy game success notification (`mixkit-success notification.wav`) | Upgrade / Forschung |
| `arrow-shot.mp3` | Arrow shot through air (`mixkit-arrow-shot-through-air-2771.wav`) | Bogenschuss |
| `melee-hit.mp3` | Sword strikes armor (`mixkit-sword-strikes-armor-2765.wav`) | Nahkampftreffer |

Passende Kategorieseiten:
...
Lizenzübersicht: https://pixabay.com/service/license-summary/

| Datei im Spiel | Originaltitel / Urheber | Quelle | Verwendet für |
|---|---|---|---|
| `repair.mp3` | Wooden Mallet Hitting Metal Surface – Real Workshop Repair · arunangshubanerjee | https://pixabay.com/sound-effects/wooden-mallet-hitting-metal-surface-real-workshop-repair-359576/ | Reparatur |
| `tower-shot.mp3` | Crossbow Firing · GameWithBepis / Freesound Community | https://pixabay.com/sound-effects/crossbow-firing-95020/ | Armbrust- und schwerer Turmschuss |
| `siege-impact.mp3` | Heavy Boulder Thud · DRAGON-STUDIO | https://pixabay.com/sound-effects/film-special-effects-heavy-boulder-thud-515257/ | Katapult- und Belagerungseinschlag |
| `wave-horn.mp3` | Battle_horn_1 · kirmm / Freesound Community | https://pixabay.com/sound-effects/film-special-effects-battle-horn-1-6931/ | Beginn einer Angriffswelle |
